...
<body>
    ...
    <section class="slider d-flex align-items-center">
                        ...
                        <div class="row">
                            <div class="col-md-12" style="padding-left:30px;margin-top:90px;">
                                <div class="slider-content_wrap">
                                 <br><br>
                                <h2 class="text-white">Submit a Book</h2>
                                <form action="submit_book.php" method="POST" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-md-6">
            <label for="cover_page" class="form-label">Cover Page (Image):</label>
            <input type="file" name="cover_page" id="cover_page" class="form-control" accept="image/*" required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="keywords_tags" id="keywords_tags" class="form-control" required>
        </div>
