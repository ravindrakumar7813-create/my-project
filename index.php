                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slider-content_wrap">
                                    <h1 class="p1">A room without books is like a body without a soul.</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="styled-heading">
                        <p style="font-size:25px;">You have done the hard work of writing your best book. We help you
    ...
    <section class="main-block light-bg">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="featured-btn-wrap">
                        <a href="shop.php" class="btn btn-danger"><span class="ti-plus"></span>BROWSE BOOK</a>
                    </div>
                </div>
            </div>
        </div>
