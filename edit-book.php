...
<style>
    ...
    <!-- Page Title -->
    <title>Edit Book &amp; Directory Website Template</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <section class="slider d-flex align-items-center">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-12">
                    <div class="slider-title_box">
                        <div class="row">
                            <div class="col-md-12" style="padding-left:30px;margin-top:90px;">
                                <div class="slider-content_wrap">
                                 <br><br>
                                <h2 class="text-white">Update Book Details</h2>
                                <form action="update_book.php" method="POST" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="book_title" id="book_title" class="form-control" required value="<?php echo $rec['book_title']; ?>">
        </div>

        <!-- Author Name -->
        <div class="col-md-6">
            <label for="author_name" class="form-label">Author Name:</label>
            <input type="text" name="author_name" id="author_name" class="form-control" required value="<?php echo $rec['author_name']; ?>">
        </div>
        ...
        <div class="col-md-6">
            ...
            <select name="category" id="category" class="form-select" required>
               ...
               $selected= $rec['category'];
                $result = mysqli_query($con, "SELECT category FROM categories");
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="isbn" id="isbn" class="form-control" required value="<?php echo $rec['isbn']; ?>">
        </div>

        <!-- Book Description -->
        <div class="col-12">
            <label for="book_description" class="form-label">Book Description:</label>
            <textarea name="book_description" id="book_description" class="form-control" rows="4" required>
                <?php echo $rec['book_description']; ?></textarea>
        </div>

        <!-- Publication Date -->
        <div class="col-md-6">
            <label for="publication_date" class="form-label">Publication Date:</label>
            <input type="date" name="publication_date" id="publication_date" class="form-control" required value="<?php echo $rec['publication_date']; ?>">
        </div>

        <!-- Language -->
        <div class="col-md-6">
            <label for="language" class="form-label">Language:</label>
            <input type="text" name="language" id="language" class="form-control" required value="<?php echo $rec['language']; ?>">
        </div>

        <!-- Number of Pages -->
        <div class="col-md-6">
            <label for="number_of_pages" class="form-label">Number of Pages:</label>
            <input type="number" name="number_of_pages" id="number_of_pages" class="form-control" required value="<?php echo $rec['number_of_pages']; ?>">
        </div>
...
s
        ...
        <div class="col-md-6">
            ...
            <input type="number" step="0.01" name="price" id="price" class="form-control" required value="<?php echo $rec['price']; ?>">
        </div>

        <!-- Keywords/Tags -->
        <div class="col-md-6">
            <label for="keywords_tags" class="form-label">Keywords/Tags:</label>
            <input type="text" name="keywords_tags" id="keywords_tags" class="form-control" required value="<?php echo $rec['keywords_tags']; ?>">
        </div>

        <!-- Author Bio -->
        <div class="col-12">
            <label for="author_bio" class="form-label">Author Bio:</label>
            <textarea name="author_bio" id="author_bio" class="form-control" rows="4" required ><?php echo $rec['author_bio']; ?></textarea>
        </div>

        <!-- Submit Button -->
        <div class="col-12 text-center featured-btn-wrap"><br>
            <button type="submit" name="submit" class="btn btn-danger">Submit Book</button><br><br>
        </div>
    ...
    <section class="main-block">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="styled-heading">
                        <p style="font-size:18px;">You have done the hard work of writing your best book. We help you
                            turn it into a beautiful, professional book and present it to the world. Self publishing the
                            way it should be: easy setup, full control, no inventory, wide distribution.</p>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-3"><img src="images/publish.jpg" alt="" class="img-fluid"><br><br>
                        <div class="text-center">


                            <h3>Publish</h3>
                            <p> Editing, design, printing & distribution. Everything you need to put your best book
                                forward. Self publish like a pro</p>
                        </div>
                    </div>
                    <div class="col-lg-1"></div>
                    <div class="col-lg-3"><img src="images/print.jpg" alt="" class="img-fluid">
                        <br><br>
                        <div class="text-center">


                            <h3>print</h3>
                            <p> From 1 copy to 10000; we have you covered with print-on-demand (POD). No minimum order
                                quantity.
                    ...
                    <div class="col-lg-1"></div>
                    <div class="col-lg-3"><img src="images/distribute.jpg" alt="" class="img-fluid"><br><br>
                    <div class="text-center">
                <h3> Distribute</h3>
                <p> Sell through Pothi.com, Flipkart, Amazon.in. No investment in inventory.

Ready to self-publis</p></div>
                    </div>
